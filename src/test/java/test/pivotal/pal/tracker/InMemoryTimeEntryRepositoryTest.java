...
public class InMemoryTimeEntryRepositoryTest {
    ...
    public void create() throws Exception {
        ...
        long projectId = 123L;
        long userId = 456L;
        TimeEntry createdTimeEntry = repo.create(new TimeEntry(projectId, userId, LocalDate.parse("2020-09-23"), 8));
    ...
    public void find() throws Exception {
        ...
        long projectId = 123L;
        long userId = 456L;
        repo.create(new TimeEntry(projectId, userId, LocalDate.parse("2020-09-23"), 8));
    ...
    public void list() throws Exception {
        InMemoryTimeEntryRepository repo = new InMemoryTimeEntryRepository();
        repo.create(new TimeEntry(123L, 456L, LocalDate.parse("2020-09-23"), 8));
        repo.create(new TimeEntry(789L, 654L, LocalDate.parse("2020-09-23"), 4));

        List<TimeEntry> expected = asList(
                new TimeEntry(1L, 123L, 456L, LocalDate.parse("2020-09-23"), 8),
                new TimeEntry(2L, 789L, 654L, LocalDate.parse("2020-09-23"), 4)
        );
    ...
    public void update() throws Exception {
        InMemoryTimeEntryRepository repo = new InMemoryTimeEntryRepository();
        TimeEntry created = repo.create(new TimeEntry(123L, 456L, LocalDate.parse("2020-09-23"), 8));

        TimeEntry updatedEntry = repo.update(
                created.getId(),
                new TimeEntry(321L, 654L, LocalDate.parse("2020-09-23"), 5));

        TimeEntry expected = new TimeEntry(created.getId(), 321L, 654L, LocalDate.parse("2020-09-23"), 5);
    ...
    public void delete() throws Exception {
        ...
        long projectId = 123L;
        long userId = 456L;
        TimeEntry created = repo.create(new TimeEntry(projectId, userId, LocalDate.parse("2020-09-23"), 8));
    ...
    public void deleteKeepsTrackOfLatestIdProperly() {
        ...
        TimeEntry createdSecond = repo.create(new TimeEntry(projectId, userId, LocalDate.parse("2020-09-23"), 8));
